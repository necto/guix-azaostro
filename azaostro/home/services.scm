...
(define (symlink-all-files-in-dir original)
  (unless (string? original)
    (error 'wrong-type
           "home-direct-symlink-service-type: ORIGINAL must be a string: "
           original))
...
(define (symlink-all-files-in-all-dirs orig-dirs)
  (map symlink-all-files-in-dir orig-dirs))
